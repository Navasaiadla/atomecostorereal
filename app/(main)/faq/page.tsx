...
export default function FAQPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-gray-600 mb-8">Find answers to common questions about our products, ordering process, shipping, and more.</p>
      ...
      <div className="mb-8">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pl-10 border border-gray-200 rounded-lg text-base bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#2B5219] focus:border-transparent transition-all"
          />
        ...
        {filteredFAQs.length > 0 ? (
          ...
          <div className="text-center py-8">
            ...
            <button 
              ...
              className="mt-4 text-[#2B5219] hover:underline"
            >
      ...
      <div className="mt-12 bg-gray-50 rounded-xl p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a 
            href="/support" 
            className="bg-[#2B5219] hover:bg-[#1a3110] text-white px-6 py-3 rounded-lg text-base font-medium transition-all"
          >
            Contact Us
          </a>
          <a 
            href="mailto:support@atomecostore.com" 
            className="bg-white border border-[#2B5219] text-[#2B5219] hover:bg-gray-50 px-6 py-3 rounded-lg text-base font-medium transition-all"
          >
            Email Support
          </a>
        </div>
