      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-purple-50 p-6 rounded-lg text-center">
            <div className="text-3xl mb-3">🛒</div>
            <h3 className="font-semibold text-purple-900 mb-2">Order Issues and other</h3>
            <p className="text-purple-700 font-medium">atomecostores@gmail.com</p>
            <p className="text-sm text-purple-600 mt-2">Delivery, returns, exchanges</p>
          </div>
          
          <div className="bg-orange-50 p-6 rounded-lg text-center">
            <div className="text-3xl mb-3">🏪</div>
            <h3 className="font-semibold text-orange-900 mb-2">Seller Support</h3>
            <p className="text-orange-700 font-medium">atomecostores@gmail.com</p>
            <p className="text-sm text-orange-600 mt-2">Vendor onboarding, partnerships</p>
          </div>
        </div>
        ...
        <div className="bg-green-50 p-6 rounded-lg">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-green-600">+91-9390119683</p>
            </div>
          </div>
        </div>
